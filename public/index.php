...
<!-- <html data-ng-app="tampico34" data-ng-controller="ctrlTampico34" lang="es-ES" xmlns="http://www.w3.org/1999/xhtml"> -->
<html lang="es-ES">
<head>
	<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="plugins/fontawesome/solid.css">
    <link rel="stylesheet" href="plugins/fontawesome/regular.css">
    <link rel="stylesheet" href="plugins/fontawesome/v4-shims.css">
	...
	<div class="row no-gutters">
		<div class="col-12 col-md-4 ">
			<div class="card border-0 h-100">
				<img src="images/flexibilidad.jpg" class="card-img-top rounded-0" alt="...">
		...
		<div class="col-12 col-md-4">
			<div class="card border-0 h-100">
				<img src="images/cercania.jpg" class="card-img-top rounded-0" alt="...">
		...
		<div class="col-12 col-md-4">
			<div class="card border-0 h-100">
				<img src="images/espacio_innovador.jpg" class="card-img-top rounded-0" alt="...">
				<div class="card-body text-center bg-T34-gris px-5 pb-5 text-primary">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-12 col-md-8 p-2">
				<a href="images/sala-reuniones-virtuales-01.jpg"  data-lightbox="galeria-T34" data-title="Salas de reunión">
					<img src="images/sala-reuniones-virtuales-01.jpg" class="decolorar" width="100%">
				</a>
			</div>
			<div class="col-12 col-md-4">
				<div class="row">
					<div class="col-12 p-2">
						<a href="images/sala-reuniones-virtuales-02.jpg" data-lightbox="galeria-T34" data-title="Sala de reunión equipada con TV">
							<img src="images/sala-reuniones-virtuales-02.jpg" class="decolorar" width="100%">
						</a>
					</div>
					<div class="col-12 p-2">
						<a href="images/sala-reuniones-virtuales-03.jpg" data-lightbox="galeria-T34" data-title="Sala de reunión para 6 personas">
							<img src="images/sala-reuniones-virtuales-03.jpg" class="decolorar" width="100%">
						</a>
					</div>
				</div>
			</div>
		...
		<div class="row mb-md-5">
			<div class="col-12 col-md-4 p-2">
				<a href="images/sala-reuniones-entrada-01.jpg" data-lightbox="galeria-T34" data-title="Reunion en espacios más tranquilos del coworking">
					<img src="images/sala-reuniones-entrada-01.jpg" class="decolorar" width="100%">
				</a>
			</div>
			<div class="col-12 col-md-4 p-2">
				<a href="images/sala-reuniones-entrada-02.jpg" data-lightbox="galeria-T34" data-title="Tampico34 cuenta con espacios para todo">
					<img src="images/sala-reuniones-entrada-02.jpg" class="decolorar" width="100%">
				</a>
			</div>
			<div class="col-12 col-md-4 p-2">
				<a href="images/sala-reuniones-entrada-03.jpg" data-lightbox="galeria-T34" data-title="La comodidad es un factor diferencial">
					<img src="images/sala-reuniones-entrada-03.jpg" class="decolorar" width="100%">
				</a>
			</div>
		</div>
				...
				<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel" >
				  <div class="carousel-inner">
				    <div class="carousel-item active">
				        <img src="images/slide/hall-recibidor.png" class="d-block w-100" alt="...">
				    ...
				    <div class="carousel-item">
				        <img src="images/slide/aseo.png" class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block bg-oscuro_trans">
							<h3>Decoración con mucho gusto</h3>
						</div>
				    </div>
				    <div class="carousel-item">
				        <img src="images/slide/aseo-adaptado.png" class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block bg-oscuro_trans">
							<h3>WC Tampico34</h3>
						</div>
				    </div>
				    <div class="carousel-item">
				        <img src="images/slide/despacho-executive.png" class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block bg-oscuro_trans">
							<h3>Espacios innovadores en Tampico34</h3>
						</div>
				    </div>
				    <div class="carousel-item">
				        <img src="images/slide/detalle-office.png" class="d-block w-100" alt="...">
						<div class="carousel-caption d-none d-md-block bg-oscuro_trans">
...
<script src="plugins/lightbox2/lightbox.js"></script>
